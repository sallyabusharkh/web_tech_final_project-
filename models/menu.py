...
response.menu += [
    (T('Home'), False, URL('courseRegistrationSys','default', 'index'))
...
if not configuration.get('app.production'):
    ...
    response.menu += [
        (T('schedules'), False, URL('courseRegistrationSys','defult', 'schedules')),
        (T('addSchedule'), False, URL('courseRegistrationSys','defult', 'addSchedule')),
        (T('courses'), False, URL('courseRegistrationSys','defult', 'courses')) ,  
        (T('Add courses'), False, URL('courseRegistrationSys','defult', 'addcourse'))
